...
ActiveRecord::Schema[7.0].define(version: 2023_06_07_144655) do
  ...
  create_table "release_commit_logs", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "train_run_id", null: false
    t.string "from", null: false
    t.jsonb "commits"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["train_run_id"], name: "index_release_commit_logs_on_train_run_id"
  end
