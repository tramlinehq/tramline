...
class Faraday::Retry::Middleware < ::Faraday::Middleware
  ...
  #
  # source://faraday-retry//lib/faraday/retry/middleware.rb#122
  ...
  #
  # source://faraday-retry//lib/faraday/retry/middleware.rb#180
  def build_exception_matcher(exceptions); end

  # source://faraday-retry//lib/faraday/retry/middleware.rb#128
  def calculate_sleep_amount(retries, env); end

  # @param env [Faraday::Env]
  #
  # source://faraday-retry//lib/faraday/retry/middleware.rb#142
  def call(env); end
  ...
  #
  # source://faraday-retry//lib/faraday/retry/middleware.rb#217
  def calculate_rate_limit_reset(env); end

  # MDN spec for Retry-After header:
  # https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Retry-After
  #
  # source://faraday-retry//lib/faraday/retry/middleware.rb#223
  ...
  # source://faraday-retry//lib/faraday/retry/middleware.rb#238
  def parse_retry_header(env, header); end

  # @return [Boolean]
  #
  # source://faraday-retry//lib/faraday/retry/middleware.rb#201
