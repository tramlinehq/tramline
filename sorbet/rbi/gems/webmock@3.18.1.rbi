...
#
# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#249
class MessageMock
  # @return [MessageMock] a new instance of MessageMock
  #
  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#252
  ...
  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#256
...
# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#13
class WebMock::HttpLibAdapters::HTTPClientAdapter < ::WebMock::HttpLibAdapter
  class << self
    # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#33
    def disable!; end

    # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#24
    def enable!; end
  end
end

# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#17
WebMock::HttpLibAdapters::HTTPClientAdapter::OriginalHttpClient = HTTPClient

# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#21
...
# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#231
class WebMockHTTPClient < ::HTTPClient
  include ::WebMockHTTPClients

  private

  # source://httpclient/2.8.3/lib/httpclient.rb#1229
  def do_get_block_without_webmock(req, proxy, conn, &block); end

  # source://httpclient/2.8.3/lib/httpclient.rb#1267
  def do_get_stream_without_webmock(req, proxy, conn); end
end

# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#45
module WebMockHTTPClients
  # @raise [HTTPClient::TimeoutError]
  #
  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#115
  def build_httpclient_response(webmock_response, stream = T.unsafe(nil), req_header = T.unsafe(nil), &block); end

  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#157
  def build_request_signature(req, reuse_existing = T.unsafe(nil)); end

  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#130
  ...
  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#103
  def do_request_async(method, uri, query, body, extheader); end

  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#200
  def previous_signature_for(signature); end

  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#196
  def webmock_request_signatures; end

  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#188
  ...
  # the client session
  #
  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#211
  def headers_from_session(uri); end

  # source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#220
  def synchronize_request_response; end
end
...
# source://webmock//lib/webmock/http_lib_adapters/httpclient_adapter.rb#239
