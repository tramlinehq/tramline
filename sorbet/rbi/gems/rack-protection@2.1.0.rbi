...
#
# source://rack-protection//lib/rack/protection/authenticity_token.rb#84
class Rack::Protection::AuthenticityToken < ::Rack::Protection::Base
  ...
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#175
  def compare_with_real_token(token, session); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#187
  def decode_token(token); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#183
  ...
  # like BREACH.
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#149
  def mask_token(token); end

  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#171
  def masked_token?(token); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#179
  def real_token(session); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#115
  def set_token(session); end

  # Essentially the inverse of +mask_token+.
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#158
  def unmask_token(masked_token); end

  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#167
  ...
  # @return [Boolean]
  #
  # source://rack-protection//lib/rack/protection/authenticity_token.rb#121
  def valid_token?(session, token); end

  # source://rack-protection//lib/rack/protection/authenticity_token.rb#191
  def xor_byte_strings(s1, s2); end

  class << self
    # source://rack-protection//lib/rack/protection/authenticity_token.rb#94
    def random_token; end

    # source://rack-protection//lib/rack/protection/authenticity_token.rb#90
    def token(session); end
  end
end

# source://rack-protection//lib/rack/protection/authenticity_token.rb#85
