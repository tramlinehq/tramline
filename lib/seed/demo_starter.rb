...
# This file should contain all the record creation needed to seed the database with its demo values.
# It creates a demo organization with teams, apps, releases, commits, and integrations.
...
# Clear existing data for clean seeds
...
apps = platforms.map do |platform|
  app = App.create!(
    organization: organization,
...
apps.each do |app|
  ...
  # Create a release platform for each train
  ...
  # Create steps for the release platform
  ...
  # Create integrations based on app platform
