  ...
  describe "#process" do
    context "with Linear integration" do
      ...
      it "links Linear tickets correctly" do
        ...
        expect(result.first).to include("github.com/tramline/repo/pull/2591")
      end
      ...
      it "handles tickets in brackets" do
        ...
        expect(result.first).to include("• [<https://linear.app/dummy/issue/IFNO-4936%7CIFNO-4936>] Modify order payload fix (<https://github.com/tramline/repo/pull/15624%7C#15624>)")
      end
    ...
    context "with GitHub integration" do
      ...
      it "links GitHub PRs correctly" do
        ...
        expect(result.first).to include("github.com/tramline/repo/pull/2608")
      end
    end
