...
describe VersioningStrategies::Semverish do
  ...
  describe "comparisons" do
    ...
    it "compares a partial and a proper semver" do
      bigger = described_class.new("1.2.1")
      smaller = described_class.new("1.2")

      expect do
        expect(bigger > smaller).to be(true)
    ...
    it "determines sort order with mixed partial and proper semverish" do
      ...
      expect([v1, v2, v3, v4, pv1, pv2, pv3, pv4, pv5].sort).to eq([pv5, v3, pv3, v1, v2, pv4, pv1, pv2, v4])
    end
  end
