...
RSpec.describe ReleaseHealthEvent do
  describe "callbacks" do
    describe "#trigger_halt_on_unhealthy" do
      ...
      let(:release_health_rule) { create(:release_health_rule, :session_stability, is_halting: true) }
      ...
      context "when an unhealthy event is created with a halting rule" do
      ...
      context "when an unhealthy event is created with a non-halting rule" do
        let(:release_health_rule) { create(:release_health_rule, :session_stability, is_halting: false) }
