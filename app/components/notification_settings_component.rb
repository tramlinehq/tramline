class NotificationSettingsComponent < ViewComponent::Base
  ...
  NOTIFICATIONS = {
    ...
    staged_rollout_updated: {number: 8, icon: "chart.svg", description: "The staged rollout was increased for the production build in the store."},
    staged_rollout_paused: {number: 9, icon: "pause.svg", description: "The staged rollout was paused for the production build in the store."},
    staged_rollout_resumed: {number: 10, icon: "play.svg", description: "The staged rollout was resumed for the production build in the store."},
