class Triggers::PreReleaseGroup
  include Memery

  RELEASE_HANDLERS = {
    "almost_trunk" => Triggers::PreRelease::AlmostTrunk,
    "parallel_working" => Triggers::PreRelease::ParallelBranches,
    "release_backmerge" => Triggers::PreRelease::ReleaseBackMerge
  }
