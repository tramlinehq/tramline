...
#  production_release_id    :uuid             uniquely indexed => [release_health_rule_id, release_health_metric_id], indexed
#  release_health_metric_id :uuid             not null, uniquely indexed => [deployment_run_id, release_health_rule_id], uniquely indexed => [production_release_id, release_health_rule_id], indexed
#  release_health_rule_id   :uuid             not null, uniquely indexed => [deployment_run_id, release_health_metric_id], uniquely indexed => [production_release_id, release_health_metric_id], indexed
#
