...
#  commit_hash             :string           not null, uniquely indexed => [release_id, release_changelog_id]
...
#  release_changelog_id    :uuid             uniquely indexed => [commit_hash, release_id], indexed
#  release_id              :uuid             uniquely indexed => [commit_hash, release_changelog_id], indexed => [timestamp]
